...
//            ACPage, World, EntityPlayer, Loc, 
//            IInterceptHarvest, EntityItem, ItemStack, IInterceptBlockSet, 
//            EntityPlayerSP, InventoryPlayer, IReach, DungeonLoot, 
//            Item, Achievement
        ...
        if(instance == null)
        {
            try
            {
                ...
                for(int j = 0; j < athread.length; j++)
                {
                    ...
                    Field field = (java.lang.Thread.class).getDeclaredField("target");
