...
public class TeleporterAelyth extends Teleporter
{

    public TeleporterAelyth()
    {
    ...
    public boolean func_4106_b(World world, Entity entity)
    {
        ...
        for(int j1 = l - c; j1 <= l + c; j1++)
        {
            ...
            for(int j2 = i1 - c; j2 <= i1 + c; j2++)
            {
                ...
                {
                    if(world.getBlockId(j1, k2, j2) != mod_Aelyth.AelythPortal.blockID)
                    {
                        continue;
                    }
                    for(; world.getBlockId(j1, k2 - 1, j2) == mod_Aelyth.AelythPortal.blockID; k2--) { }
        ...
        if(d >= 0.0D)
        {
            ...
            if(world.getBlockId(k1 - 1, l1, i2) == mod_Aelyth.AelythPortal.blockID)
            {
                d2 -= 0.5D;
            }
            if(world.getBlockId(k1 + 1, l1, i2) == mod_Aelyth.AelythPortal.blockID)
            ...
            if(world.getBlockId(k1, l1, i2 - 1) == mod_Aelyth.AelythPortal.blockID)
            {
                d6 -= 0.5D;
            }
            if(world.getBlockId(k1, l1, i2 + 1) == mod_Aelyth.AelythPortal.blockID)
        ...
        for(int j5 = 0; j5 < 4; j5++)
        {
            ...
            for(int j6 = 0; j6 < 4; j6++)
            {
                for(int k7 = -1; k7 < 4; k7++)
                {
                    ...
                    world.setBlockWithNotify(l8, i10, j11, flag1 ? Block.dirt.blockID : mod_Aelyth.AelythPortal.blockID);
                }
