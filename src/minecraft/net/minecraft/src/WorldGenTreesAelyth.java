...
public class WorldGenTreesAelyth extends WorldGenerator
{

    public WorldGenTreesAelyth()
    {
    }
    ...
    public boolean generate(World world, Random random, int i, int j, int k)
    {
        ...
        if(j1 != mod_Aelyth.AelythGrass.blockID && j1 != mod_Aelyth.AelythDirt.blockID || j >= 128 - l - 1)
        {
            return false;
        }
        world.setBlock(i, j - 1, k, mod_Aelyth.AelythDirt.blockID);
