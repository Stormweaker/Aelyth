...
public class MapGenCavesAelyth extends MapGenBase
{

    public MapGenCavesAelyth()
    {
    }
                ...
                for(int k3 = d10; k3 < i2; k3++)
                {
                    ...
                    do
                    {
                        ...
                        if(d14 > -0.69999999999999996D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D)
                        {
                            ...
                            if(byte0 == mod_Aelyth.AelythGrass.blockID)
                            {
                                flag3 = true;
                            }
                            if(byte0 == mod_Aelyth.AelythStone.blockID || byte0 == mod_Aelyth.AelythDirt.blockID || byte0 == mod_Aelyth.AelythGrass.blockID)
                            {
                                if(i4 < 10)
                                {
                                ...
                                {
                                    abyte0[l3] = 0;
                                    if(flag3 && abyte0[l3 - 1] == mod_Aelyth.AelythDirt.blockID)
                                    {
                                        abyte0[l3 - 1] = (byte)mod_Aelyth.AelythGrass.blockID;
                                    }
                                }
                            }
                        }
